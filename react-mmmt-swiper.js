                ...
                className: 'swiper-container' + (this.props.className ? ' ' + this.props.className : '')
                    ...
                    React.Children.map(this.props.children, function(child, index) {
                        return React.cloneElement(child, {
                            style: Object.assign(child.props.style || {}, styles.child),
                            className: 'swiper-slide ' + child.props.className
                        })
                    })
                ),
                this.props.pagination ? React.cloneElement(this.props.pagination, {
                    className: 'swiper-pagination' + (this.props.pagination.props.className ? ' ' + this.props.pagination.props.className : ''),
                    ref: 'pagination',
                    key: 'pagination'
                }) : null
            ])
