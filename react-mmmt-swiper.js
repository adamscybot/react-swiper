...
(function (root, factory) {
  ...
  var ReactSwiper = React.createClass({
	...
	render: function() {
	  return React.createElement('div', Object.assign({}, this.props, {style: styles.container, className: 'swiper-container' + (this.props.className ? ' ' + this.props.className : ''), key: 'swiper'}),
	    [React.createElement('div', {style: styles.wrapper, className: 'swiper-wrapper', key: 'swiper-wrapper'},
	    ...
	    this.props.pagination ? React.cloneElement(this.props.pagination, {className: 'swiper-pagination' + (this.props.pagination.props.className ? ' ' + this.props.pagination.props.className : ''), ref: 'pagination', key: 'pagination'}) : null]
	  );
	}
  });
